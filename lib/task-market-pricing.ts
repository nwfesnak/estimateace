...
const TASK_RULES: TaskRule[] = [
  ...
  // —— Plumbing / electrical / HVAC unit jobs ——
  {
    id: 'water_softener',
    label: 'water softener install',
    pattern: /water\s*softener/i,
    minTotal: 900,
    midTotal: 1600,
    maxTotal: 3200,
    typicalHours: 5,
  ...
  {
    id: 'garbage_disposal_plumb',
    label: 'under-sink plumbing repair',
    pattern: /under[\s-]?sink|p[\s-]?trap|supply\s*line|shut[\s-]?off\s*valve/i,
    exclude: /whole\s*bath|remodel/i,
    minTotal: 180,
    midTotal: 320,
    maxTotal: 650,
    typicalHours: 2,
  ...
  },
  {
    ...
    pattern: /ev\s*charger|electric\s*vehicle\s*charger|tesla\s*wall|level\s*2\s*charger/i,
    minTotal: 800,
    midTotal: 1400,
    maxTotal: 2800,
    typicalHours: 5,
  ...
  {
    id: 'ceiling_light_pack',
    label: 'recessed light install (each)',
    pattern: /recessed\s*(?:can|light)|can\s*light|pot\s*light/i,
    exclude: /whole[\s-]?house|all\s+rooms|\d{2,}\s*lights/i,
    minTotal: 180,
    midTotal: 320,
    maxTotal: 550,
    typicalHours: 1.5,
  ...
  {
    id: 'thermostat',
    label: 'thermostat install',
    pattern: /thermostat|nest\b|ecobee/i,
    minTotal: 150,
    midTotal: 280,
    maxTotal: 550,
    typicalHours: 1.5,
  ...
  {
    id: 'ac_tuneup',
    label: 'AC / HVAC tune-up',
    pattern: /(?:ac|a\/c|hvac|air\s*condition)\s*(?:tune|service|maintain|check)|tune[\s-]?up/i,
    minTotal: 120,
    midTotal: 200,
    maxTotal: 350,
    typicalHours: 1.5,
  ...
  {
    id: 'furnace_filter_service',
    label: 'furnace service call',
    pattern: /furnace\s*(?:service|repair|clean)|boiler\s*(?:service|repair)/i,
    exclude: /replace|new\s+furnace|install/i,
    minTotal: 150,
    midTotal: 275,
    maxTotal: 550,
    typicalHours: 2,
  ...
  {
    id: 'garbage_disposal_alt',
    label: 'dishwasher supply / drain hookup',
    pattern: /dishwasher\s*(?:hook|drain|supply)|hook\s*up\s*dishwasher/i,
    minTotal: 150,
    midTotal: 275,
    maxTotal: 450,
    typicalHours: 1.5,
  ...
  // —— Landscaping / exterior unit ——
  {
    id: 'tree_removal_small',
    label: 'small tree / stump removal',
    pattern: /(?:small\s+)?tree\s*(?:remov|cut|trim)|stump\s*(?:grind|remov)/i,
    exclude: /acre|orchard|dozens?/i,
    minTotal: 350,
    midTotal: 750,
    maxTotal: 2500,
    typicalHours: 4,
  ...
  {
    id: 'sprinkler_head',
    label: 'sprinkler head replace',
    pattern: /sprinkler\s*head|irrigation\s*head/i,
    exclude: /whole\s*system|new\s*irrigation/i,
    minTotal: 85,
    midTotal: 150,
    maxTotal: 280,
    typicalHours: 0.75,
  ...
  {
    id: 'mailbox_post',
    label: 'mailbox / post install',
    pattern: /mailbox|mail\s*box/i,
    minTotal: 120,
    midTotal: 220,
    maxTotal: 450,
    typicalHours: 1.5,
  ...
  },
  {
    ...
    pattern: /handyman|odd\s*job|honey[\s-]?do|misc\s*repair|general\s*repair/i,
    minTotal: 125,
    midTotal: 250,
    maxTotal: 500,
    typicalHours: 2,
