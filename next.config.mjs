...
const nextConfig = {
  ...
  async headers() {
    // CSP: unsafe-eval removed. 'unsafe-inline' remains for Next.js/Tailwind bootstrapping
    // until a nonce-based CSP migration. Do NOT set Access-Control-Allow-Origin globally —
