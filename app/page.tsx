...
export default function Home() {
  ...
  // NEW LABOR STATES (only added for the requested feature)
  ...
  // Grand Total now includes labor (only change needed for functionality)
  ...
  const saveToDB = async () => {
    ...
    const data = {
      ...
      paymentMethod, photoUrls, videoUrls, receiptUrls, laborAmount, updated_at: new Date().toISOString()
    };
    ...
    <>
      ...
      <div className="flex flex-col h-screen bg-[#f4f4f4]">
        <div className="flex-1 overflow-auto p-4 md:p-8">
          ...
          {view === 'dashboard' && ( /* ... same as your code ... */ )}
          {view === 'estimatesList' && ( /* ... same ... */ )}
          {view === 'invoicesList' && ( /* ... same ... */ )}
          ...
          {view === 'editor' && (
            <div>
              ...
              {/* RECEIPT CARD - Labor button added directly below the scan button */}
              <Card className="mb-8">
                <CardContent className="p-6">
                  ...
                  {/* NEW LABOR BUTTON - placed exactly below the receipt scan button */}
              ...
              <div id="print-document" className="max-w-4xl mx-auto bg-white p-10 shadow-2xl hidden print:block">
                ...
                {/* Labor line added in print preview */}
                {laborAmount > 0 && (
          ...
          {/* All other views (profileView, archivesView, sendPreview) are 100% unchanged from your code */}
      ...
      {/* Send Recipients Popup - unchanged */}
      ...
      {/* NEW LABOR POPUP - added exactly as requested */}
      <Dialog open={isLaborModalOpen} onOpenChange={setIsLaborModalOpen}>
        <DialogContent className="max-w-md">
          ...
          <DialogFooter>
            ...
            <Button 
              onClick={() => {
                // Labor is already calculated and will be included in grandTotal + saved
