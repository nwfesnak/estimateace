    ...
    <>
      ...
      <div className="flex flex-col h-screen bg-[#f4f4f4]">
        <div className="flex-1 overflow-auto p-4 md:p-8">
          ...
          {/* PROFILE FULL PAGE - Certificate now guaranteed at bottom */}
          {view === 'profileView' && (
            <div>
              ...
              <Card className="mb-8">
                <CardContent className="p-8 space-y-8">
                  ...
                  {/* Certificate preview moved to the absolute bottom of the page */}
                  {profile.certificateUrl && (
                    <div className="mt-12 border-2 border-dashed border-gray-300 rounded-xl p-8 text-center">
